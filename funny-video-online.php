...
License: GPL2
*/
define(funny_video_online_READER_URL_RSS_DEFAULT, 'http://fun.onlinerel.com/category/funny-video/feed/');
define(funny_video_online_READER_TITLE, 'Funny video online');
...
function funny_video_online_widget_ShowRss($args)
{
	...
	if( $options == false ) {
		$options[ 'funny_video_online_widget_url_title' ] = funny_video_online_READER_TITLE;
		$options[ 'funny_video_online_widget_RSS_url' ] = funny_video_online_READER_URL_RSS_DEFAULT;
		$options[ 'funny_video_online_widget_RSS_count_items' ] = funny_video_online_MAX_SHOWN_ITEMS;
	}

 $RSSurl = funny_video_online_READER_URL_RSS_DEFAULT;
...
function funny_video_online_widget_Admin()
{
	...
	//default settings
	if( $options == false ) {
		$newoptions[ 'funny_video_online_widget_url_title' ] = funny_video_online_READER_TITLE;
		$newoptions[ 'funny_video_online_widget_RSS_url' ] = funny_video_online_READER_URL_RSS_DEFAULT;
	...
	$funny_video_online_widget_RSS_url = funny_video_online_READER_URL_RSS_DEFAULT;	
...
<p> <h3>Add the widget "Funny video online"  to your sidebar from Appearance->Widgets and configure the widget options.</h3></p>
 <hr /> <hr />
